...
function pintarCarrito() {
  ...
  carrito.forEach((producto) => {
    tablaCarrito.innerHTML += `
      ...
      <div class="direccionTextoTabla">${producto.id}</div>
      `;
  });
}
...
const contGrid = document.getElementById("contGrid");
 fetch("./productos/productos.json")
  ...
  <div class="card-body">
    ...
    <a href="#" id="btnCompra${producto.id}" class="btn btn-primary">Comprar</a>
  </div>
</div>
    `
    })
  ...
  const btnComprar = document.getElementById("btnCompra${producto.id}");
